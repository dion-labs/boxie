...
- **Android:** signed APK in Releases. Android 8 or later. First create your vault on the web, then sign into the same Boxie account and approve pairing from your existing device.
