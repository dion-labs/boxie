...
Public registration is planned for **September 6, 2026**, after final sync validation. Start on the website with a Google account for Boxie and a personal Microsoft account for Outlook, then pair additional devices. Work/school Microsoft accounts and direct Gmail connections are not supported yet.

- **Web:** hosted at boxie.dionlabs.ai.
- **Android:** [signed 0.2.1 preview APK](https://github.com/dion-labs/boxie/releases/tag/android-v0.2.1-preview.1). Android 8 or later. First create your vault on the web, then sign into the same Boxie account and approve pairing from your existing device.
